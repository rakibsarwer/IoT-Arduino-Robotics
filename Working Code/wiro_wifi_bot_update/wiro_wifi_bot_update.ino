        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
           ...
           // Display the HTML web page
            ...
            client.println(".button { background-color: #195B6A; border: none;border-radius: 50%;right:520px;bottom:520px; color: white; padding: 16px 40px;");
            client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");
            client.println(".button2 {background-color: #fc2808;}</style></head>");
...
//            client.println("<p>GPIO 5 - State " + output5State + "</p>");
            ...
            if (output4State=="off") {
              client.println("<p><a href=\"/4/on\"><button class=\"button\">Backword</button></a></p>");
            } else {
              client.println("<p><a href=\"/4/off\"><button class=\"button button2\">Backword</button></a></p>");
            }
           ...
           // client.println("<p>GPIO 3 - State " + output3State + "</p>");
            // If the output5State is off, it displays the ON button       
            if (output3State=="off") {
              client.println("<p><a href=\"/3/on\"><button class=\"button\">Left</button></a></p>");
            } else {
              client.println("<p><a href=\"/3/off\"><button class=\"button button2\">Left</button></a></p>");
            } 
            ...
            if (output2State=="off") {
              ...
              client.println("<p><a href=\"/2/off\"><button class=\"button button2\">Right</button></a></p>");
            }
