...
const char* ssid = "404 Network Unavailable"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "*+3wrasm!"; // Your Wifi password, in case you have open network comment the whole statement.
