...
void Send2Pachube(String sms)       //send data with gsm
{
  ...
  mySerial.println("AT+CIPSTART=\"TCP\",\"192.168.0.106\",\"80\"");//start up the connection
  ...
  delay(4000);
  ShowSerialData();
  String str="GET http://192.168.0.106/send.php?request=123345";  
  mySerial.println(AT+HTTPPARA=\"URL\",\")
