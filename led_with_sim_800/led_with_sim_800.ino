...
*/
 mySerial.println("AT+CSQ"); // Signal quality check
  ...
  delay(2000); 
  ShowSerialData();
  mySerial.print("AT+HTTPPARA=\"URL\",\"iottest-pro.000webhostapp.com/getstate.php?color=");
mySerial.print(sms);
mySerial.println("\"");
//String str="AT+HTTPsPARA=\"URL\",\"rakibsarwar3.000webhostapp.com/bus.php?bus=\""+sms;  
  
  //mySerial.println(str);//begin send data to remote server
   //mySerial.println("AT+HTTPPARA=\"URL\",\"iottest-pro.000webhostapp.com/test.php?bus=\""+sms);// setting the httppara, the second parameter is the website you want to access
  delay(1000);
